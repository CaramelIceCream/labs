...
author: |
	 Дерябина Мария Сергеевна НФИбд-02-18\inst{1}
...
![График решения для случая 2](image/1.png){ #fig:003 width=70% height=70% }
...
![График решения для случая 3](image/3.png){ #fig:005 width=70% height=70% }

## Случай 3. Колебания гармонического осциллятора c затуханием и под действием внешней силы

$\ddot{x}+\dot{x}+11x=2\cos{t}$

![Фазовый портрет для случая 3](image/3.1.png){ #fig:006 width=70% height=70% }
